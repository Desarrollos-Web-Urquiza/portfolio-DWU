export default [
    {
     ...
     {
      title:"Redux",
      icon: "/images/logos/redux.svg",
      alt:"Redux",
      link: "https://redux.js.org/",
      description:'Una forma rápida y efectiva de esparcir el estado por toda la aplicación en mis proyectos hechos con React.',
    },
    {
      title:"Firebase",
    ...
    {
      title:"Vue",
      icon:"/images/logos/Vue.js_Logo_2.svg",
      alt:"Vue",
    ...
    },
    {
      ...
      description:"Me adentré al mundo QA aprendiendo Jest. Gracias a Jest pude realizar unit tests de componentes del frontend que desarrollo, asegurando así la calidad de mi código.",
      
    },
    {
      title:"Cypress",
      icon:"/images/logos/cypress.png",
      alt:"Cypress",
      link: "https://docs.cypress.io/",
      description:"Llegué a dominar la herramienta Cypress para realizar testeos muy completos. Al combinarlo con tecnologías como Cucumber, pude desarrollar pruebas de tipo BDD.",
